...
Another potential human trafficking indicator is classified ads that list multiple locations as potential meet-up places (Figure 5), which are likely part of a [circuit](https://polarisproject.org/wp-content/uploads/2019/09/Human-Trafficking-Sex-Trafficking-Glossary.pdf). For example, the West Coast trafficking circuit, which includes San Diego, Las Vegas, Portland, and the cities between these locations, is a popular route used by traffickers.
...
This research originally appeared as a [Recorded Future report](https://assets.recordedfuture.com/insikt-report-pdfs/2022/cta-2022-0830.pdf) (CTA-2022-0111).
